    ...
    <div class="bg-surface-0 dark:bg-surface-900 p-6 shadow rounded-border max-w-[500px] w-full lg:w-6/12 mx-auto">
      ...
      <Loading :loading="loading" class="!max-h-[100px]">
        <Form @submit="auth" method="post">
          <label for="username" class="text-surface-900 dark:text-surface-0 font-medium mb-2 block">Логин</label>
          <InputText id="username" name="username" type="text" placeholder="Введите логин" class="w-full mb-4" required/>
