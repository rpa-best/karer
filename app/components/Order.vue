    ...
    <Form :initial-values="myOrder" @submit="save">
        <div class="grid gap-8 grid-cols-6 mt-5">
            <div class="col-span-6">
                <FloatLabel>
                    <Select emptyMessage="Пусто" required id="car" style="width: 100%" name="car" :disabled="disabled" :options="cars" option-value="id" option-label="number" />
                    <label for="car" style="font-size: 12px">Машина</label>
                </FloatLabel>
            </div>
            <div class="col-span-6">
                <FloatLabel>
                    <Select emptyMessage="Пусто" required id="driver" style="width: 100%" name="driver" :disabled="disabled" :options="drivers" option-value="id" option-label="name" />
                    <label for="driver" style="font-size: 12px">Водитель</label>
                </FloatLabel>
            </div>
            <div class="col-span-6">
                <FloatLabel>
                    <InputText required id="address" style="width: 100%" name="address" :disabled="disabled" />
                    <label for="address" style="font-size: 12px">Адрес поставки</label>
                </FloatLabel>
            </div>
            <div class="col-span-6">
                <FloatLabel>
                    <Select emptyMessage="Пусто" required id="nomenclature" style="width: 100%" name="nomenclature" :disabled="disabled" :options="nomenclatures" option-value="uuid" option-label="name" />
                    <label for="nomenclature" style="font-size: 12px">Номенклатура</label>
                </FloatLabel>
            </div>
            <div class="col-span-3">
                <FloatLabel>
                    <InputNumber required id="per_price" style="width: 100%" name="per_price" :disabled="disabled" />
                    <label for="per_price" style="font-size: 12px">Стоимость за ед.</label>
                </FloatLabel>
            </div>
            <div class="col-span-3">
                <FloatLabel>
                    <InputNumber required id="price" style="width: 100%" name="price" :disabled="disabled" />
                    <label for="price" style="font-size: 12px">Сумма</label>
                </FloatLabel>
            </div>
            <div class="col-span-2">
                <FloatLabel>
                    <InputNumber id="additive" style="width: 100%" name="additive" :disabled="disabled" />
                    <label for="additive" style="font-size: 12px">Добавка</label>
                </FloatLabel>
            </div>
            <div class="col-span-2">
                <FloatLabel>
                    <InputNumber id="order" style="width: 100%" name="order" :disabled="disabled" />
                    <label for="order" style="font-size: 12px">Заказ</label>
                </FloatLabel>
            </div>
            <div class="col-span-2">
                <FloatLabel>
                    <InputNumber id="fact" style="width: 100%" name="fact" :disabled="disabled" />
